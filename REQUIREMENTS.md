...
- [ done ] Be able to show content offline
...
- Go back to the web pack config and add the setup for service workers. â€¨
- Test that the site is now available even when you stop your local serverâ€¨
